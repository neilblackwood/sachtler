	<div class="table table-product-row product-category product_view_<?php echo wpsc_the_product_id(); ?> <?php echo wpsc_category_class(); ?>">
        ...
        --><div class="center span2">
        	<?php echo get_product_specs(wpsc_the_product_id(),'weight',true); ?>
        </div><!--
        --><div class="center span2">
        	<?php echo get_product_specs(wpsc_the_product_id(),'height',true); ?>
        </div><!--
        --><div class="center span1">
        	<input type="checkbox" class="compareInput" category='tripod-systems' value='<?php echo wpsc_the_product_id(); ?>'  onchange='setCompareProductCookie("tripod-systems-compare", this);'></input>
        </div><!--
    --></div>