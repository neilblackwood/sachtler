	<div class="table table-product-row product-category product_view_<?php echo wpsc_the_product_id(); ?> <?php echo wpsc_category_class(); ?>">
        ...
        --><div class="center span2">
        	<?php echo get_product_specs(wpsc_the_product_id(),'on_shot_stroke',true); ?>
        </div><!--
        --><div class="center span2">
        	<?php echo get_product_specs(wpsc_the_product_id(),'clearance',true); ?>
        </div><!--
        --><div class="center span1">
        	<input type="checkbox" class="compareInput" category='pedestals' value='<?php echo wpsc_the_product_id(); ?>'  onchange='setCompareProductCookie("pedestals-compare", this);'></input>
        </div><!--
    --></div>