...
<div class="cycloneslider cycloneslider-template-sachtler" id="cycloneslider-<?php echo $slider_id; ?>" style="max-width:<?php echo $slider_settings['width']; ?>px">
		...
		<?php foreach($slider_metas as $i=>$slider_meta): ?>
			<div class="cycloneslider-slide" <?php echo cyclone_slide_settings($slider_meta, $slider_settings); ?>>
				<?php if ($slider_meta['type']=='image') : ?>
					...
					<div class="cycloneslider-caption span5 new-line">
                    	<div class="inside">
                            <h1 class="cycloneslider-caption-title"><?php echo $slider_meta['title'];?></h1>
                            <p class="cycloneslider-caption-description"><?php echo $slider_meta['description'];?></p>
                            <?php if ($slider_meta['link']!='') : ?><a class="cycloneslider-caption-button white-button" target="<?php echo ('_blank'==$slider_meta['link_target']) ? '_blank' : '_self'; ?>" href="<?php echo $slider_meta['link'];?>"><?php echo $slider_meta['img_title'];?></a><?php endif; ?>
						</div>
					</div>
					<?php endif; ?>
