	<div class="table table-product-row product-category product_view_<?php echo wpsc_the_product_id(); ?> <?php echo wpsc_category_class(); ?>">
        ...
        --><div class="center span2">
        	<?php echo get_product_specs(wpsc_the_product_id(),'counterbalance_steps',true); ?>
        </div><!--
        --><div class="center span2">
        	<?php echo get_product_specs(wpsc_the_product_id(),'drag_grades',true); ?>
        </div><!--
        --><div class="center span2">
        	<?php echo get_product_specs(wpsc_the_product_id(),'head_fitting',true); ?>
        </div><!--
        --><div class="center span1">
        	<input type="checkbox" class="compareInput" category='fluid-heads' value='<?php echo wpsc_the_product_id(); ?>'  onchange='setCompareProductCookie("fluid-heads-compare", this);'></input>
        </div><!--
    --></div>