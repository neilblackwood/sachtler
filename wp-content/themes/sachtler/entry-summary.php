...
<h2 class="prodtitle entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( __('Read %s', 'sachtler'), the_title_attribute('echo=0') ); ?>" rel="bookmark">
<?php printf( __('Read %s', 'sachtler'), the_title_attribute('echo=0') ); ?></a></h2>
<?php the_excerpt( sprintf(__( 'continue reading %s', 'sachtler' ), '<span class="meta-nav">&rarr;</span>' )  ); ?>
