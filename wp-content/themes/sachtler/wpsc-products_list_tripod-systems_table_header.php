...
--><div class="wpsc-product_category_list">
	<div class="table-header-row">
        ...
        --><div class="center span2">
        	<img src="<?php echo get_bloginfo('template_directory'); ?>/images/ico/weight.png"/>
        	<p><?php _e('Weight','sachtler'); ?></p>
        </div><!--
        --><div class="center span2">
        ...
        --><div class="center span1">
        	...
        	<a href="/sachtler/product-comparison/?ct=tripod-systems" class="red-button button compare"><?php _e('Show','sachtler'); ?></a>
        </div><!--
    --></div>