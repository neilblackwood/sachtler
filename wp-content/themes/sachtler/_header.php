...
<div id="primary-navigation">
    <div class="row">
        <div class="wrapper">
            <div id="primary-menu" class="menu span9">
                <?php wp_nav_menu( array( 'theme_location' => 'primary-menu', 'walker' => new Description_Walker, 'items_wrap' => '<ul id="%1$s" class="%2$s"><!--%3$s--></ul>', ) ); ?>
            </div><!-- #primary-menu --><!--
            --><div id="configurator-menu" class="menu span3">
                <?php wp_nav_menu( array( 'theme_location' => 'configurator-menu') ); ?>
            </div><!-- #configurator-menu -->  
        </div><!-- .wrapper -->
    </div><!-- .row -->
