...
/**
* CUSTOM wpsc breadcrumb parent function
* @return string - the breadcrumb parent
*/
function wpsc_breadcrumb_parent() {
	global $wpsc_breadcrumbs;

	if($wpsc_breadcrumbs->breadcrumb['parent'] == '') {
		return false;
	} else {
		return $wpsc_breadcrumbs->breadcrumb['parent'];
	}
}
